...
export const PaginateStreamRequest: MessageFns<PaginateStreamRequest> = {
    encode(
        ...
        if (message.doNotUseSnapshots !== false) {
            writer.uint32(64).bool(message.doNotUseSnapshots);
        }
        return writer;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 8: {
                    ...
                    message.doNotUseSnapshots = reader.bool();
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object: any): PaginateStreamRequest {
        return {
            ...
            snapshotEventId: isSet(object.snapshotEventId)
                ...
                : "",
            doNotUseSnapshots: isSet(object.doNotUseSnapshots)
                ? globalThis.Boolean(object.doNotUseSnapshots)
                : false,
        };
    },
    ...
    toJSON(message: PaginateStreamRequest): unknown {
        ...
        if (message.doNotUseSnapshots !== false) {
            obj.doNotUseSnapshots = message.doNotUseSnapshots;
        }
        return obj;
    },
    ...
    fromPartial(object: DeepPartial<PaginateStreamRequest>): PaginateStreamRequest {
        ...
        message.doNotUseSnapshots = object.doNotUseSnapshots ?? false;
        return message;
    },
};
...
export const PaginateStreamAfterEventIdRequest: MessageFns<PaginateStreamAfterEventIdRequest> = {
    encode(
        ...
        if (message.doNotUseSnapshots !== false) {
            writer.uint32(72).bool(message.doNotUseSnapshots);
        }
        return writer;
    },
