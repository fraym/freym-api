        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4: {
                    ...
                    const entry4 = CreateRequest_DataEntry.decode(reader, reader.uint32());
...
export const CreateRequest_DataEntry: MessageFns<CreateRequest_DataEntry> = {
    encode(
        message: CreateRequest_DataEntry,
    ...
    create(base?: DeepPartial<CreateRequest_DataEntry>): CreateRequest_DataEntry {
        return CreateRequest_DataEntry.fromPartial(base ?? {});
    },
    fromPartial(object: DeepPartial<CreateRequest_DataEntry>): CreateRequest_DataEntry {
        const message = createBaseCreateRequest_DataEntry();
...
export const CreateResponse: MessageFns<CreateResponse> = {
    encode(message: CreateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
        Object.entries(message.newData).forEach(([key, value]) => {
            CreateResponse_NewDataEntry.encode(
                { key: key as any, value },
        ...
        Object.entries(message.fieldValidationErrors).forEach(([key, value]) => {
            CreateResponse_FieldValidationErrorsEntry.encode(
                { key: key as any, value },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1: {
                    ...
                    const entry1 = CreateResponse_NewDataEntry.decode(reader, reader.uint32());
                ...
                case 3: {
                    ...
                    const entry3 = CreateResponse_FieldValidationErrorsEntry.decode(
                        reader,
                        reader.uint32()
                    );
...
function createBaseCreateResponse_NewDataEntry(): CreateResponse_NewDataEntry {
    return { key: "", value: "" };
}

export const CreateResponse_NewDataEntry: MessageFns<CreateResponse_NewDataEntry> = {
    encode(
        message: CreateResponse_NewDataEntry,
        writer: BinaryWriter = new BinaryWriter()
    ): BinaryWriter {
        if (message.key !== "") {
            writer.uint32(10).string(message.key);
    ...
    decode(input: BinaryReader | Uint8Array, length?: number): CreateResponse_NewDataEntry {
        const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
    ...
    fromJSON(object: any): CreateResponse_NewDataEntry {
        return {
            key: isSet(object.key) ? globalThis.String(object.key) : "",
            value: isSet(object.value) ? globalThis.String(object.value) : "",
        };
    ...
    toJSON(message: CreateResponse_NewDataEntry): unknown {
        const obj: any = {};
        if (message.key !== "") {
            obj.key = message.key;
        }
    ...
    create(base?: DeepPartial<CreateResponse_NewDataEntry>): CreateResponse_NewDataEntry {
        return CreateResponse_NewDataEntry.fromPartial(base ?? {});
    },
    fromPartial(object: DeepPartial<CreateResponse_NewDataEntry>): CreateResponse_NewDataEntry {
        const message = createBaseCreateResponse_NewDataEntry();
        message.key = object.key ?? "";
        message.value = object.value ?? "";
        return message;
...
function createBaseCreateResponse_FieldValidationErrorsEntry(): CreateResponse_FieldValidationErrorsEntry {
    return { key: "", value: "" };
}

export const CreateResponse_FieldValidationErrorsEntry: MessageFns<CreateResponse_FieldValidationErrorsEntry> =
    {
        encode(
            message: CreateResponse_FieldValidationErrorsEntry,
            writer: BinaryWriter = new BinaryWriter()
        ): BinaryWriter {
            if (message.key !== "") {
                writer.uint32(10).string(message.key);
        ...
        decode(
            ...
            length?: number
        ): CreateResponse_FieldValidationErrorsEntry {
            const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
            let end = length === undefined ? reader.len : reader.pos + length;
        ...
        fromJSON(object: any): CreateResponse_FieldValidationErrorsEntry {
            return {
                key: isSet(object.key) ? globalThis.String(object.key) : "",
                value: isSet(object.value) ? globalThis.String(object.value) : "",
            };
        ...
        toJSON(message: CreateResponse_FieldValidationErrorsEntry): unknown {
            const obj: any = {};
            if (message.key !== "") {
                obj.key = message.key;
            }
        ...
        create(
            base?: DeepPartial<CreateResponse_FieldValidationErrorsEntry>
        ): CreateResponse_FieldValidationErrorsEntry {
            return CreateResponse_FieldValidationErrorsEntry.fromPartial(base ?? {});
        },
        fromPartial(
            object: DeepPartial<CreateResponse_FieldValidationErrorsEntry>
        ): CreateResponse_FieldValidationErrorsEntry {
            const message = createBaseCreateResponse_FieldValidationErrorsEntry();
            message.key = object.key ?? "";
            message.value = object.value ?? "";
