...
func (c *migrationsClient) DeploySchema(ctx context.Context, schemaString string, options *DeploymentOptions) (*DeploymentResponse, error) {
...
func (c *migrationsClient) ConfirmDeployment(ctx context.Context, deploymentId int64) error {
...
func (c *migrationsClient) RollbackDeployment(ctx context.Context) error {
...
func (c *migrationsClient) Close() error {
	c.mx.Lock()
	defer c.mx.Unlock()
	c.isClosed = true
...
func (c *migrationsClient) getDataFromString(schemaString string) (*managementpb.CreateDeploymentRequest, error) {
