...
var file_projections_delivery_shared_proto_rawDesc = string([]byte{
	...
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x97,
	...
	0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x64, 0x65,
	0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x0c, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12,
	0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x41, 0x0a, 0x09, 0x44, 0x61, 0x74, 0x61,
	...
	0x0a, 0x64, 0x65, 0x73, 0x63, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x22, 0x7f, 0x0a, 0x04, 0x44,
	0x61, 0x74, 0x61, 0x12, 0x3e, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x2a, 0x2e, 0x66, 0x72, 0x65, 0x79, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63,
...
var file_projections_delivery_shared_proto_goTypes = []any{
	(*AuthData)(nil),        // 0: freym.projections.delivery.AuthData
	(*DataFilter)(nil),      // 1: freym.projections.delivery.DataFilter
	(*DataFieldFilter)(nil), // 2: freym.projections.delivery.DataFieldFilter
	(*EventMetadata)(nil),   // 3: freym.projections.delivery.EventMetadata
	(*DataOrder)(nil),       // 4: freym.projections.delivery.DataOrder
	(*Data)(nil),            // 5: freym.projections.delivery.Data
	nil,                     // 6: freym.projections.delivery.AuthData.DataEntry
	nil,                     // 7: freym.projections.delivery.DataFilter.FieldsEntry
	nil,                     // 8: freym.projections.delivery.Data.DataEntry
}
var file_projections_delivery_shared_proto_depIdxs = []int32{
	6, // 0: freym.projections.delivery.AuthData.data:type_name -> freym.projections.delivery.AuthData.DataEntry
	7, // 1: freym.projections.delivery.DataFilter.fields:type_name -> freym.projections.delivery.DataFilter.FieldsEntry
	1, // 2: freym.projections.delivery.DataFilter.and:type_name -> freym.projections.delivery.DataFilter
	1, // 3: freym.projections.delivery.DataFilter.or:type_name -> freym.projections.delivery.DataFilter
	8, // 4: freym.projections.delivery.Data.data:type_name -> freym.projections.delivery.Data.DataEntry
	2, // 5: freym.projections.delivery.DataFilter.FieldsEntry.value:type_name -> freym.projections.delivery.DataFieldFilter
