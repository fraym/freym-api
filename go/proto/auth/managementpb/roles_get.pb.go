...
const file_auth_management_roles_get_proto_rawDesc = "" +
	"\n" +
	"\x1fauth/management/roles_get.proto\x12\x15freym.auth.management\x1a\x1cauth/management/shared.proto\"X\n" +
	...
	"\x05roles\x18\x01 \x03(\v2\x1b.freym.auth.management.RoleR\x05roles\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x03R\x05limit\x12\x12\n" +
	"\x04page\x18\x03 \x01(\x03R\x04page\x12\x14\n" +
	"\x05total\x18\x04 \x01(\x03R\x05total\"_\n" +
	"\x04Role\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12G\n" +
	"\x0eallowed_scopes\x18\x02 \x03(\v2 .freym.auth.management.RoleScopeR\rallowedScopesb\x06proto3"
