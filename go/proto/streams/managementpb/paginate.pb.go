...
const file_streams_management_paginate_proto_rawDesc = "" +
	...
	"\x15PaginateEventsRequest\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x14\n" +
	"\x05topic\x18\x02 \x01(\tR\x05topic\x12\x14\n" +
	"\x05types\x18\x03 \x03(\tR\x05types\x12\x12\n" +
	"\x04page\x18\x04 \x01(\x03R\x04page\x12\x19\n" +
	"\bper_page\x18\x05 \x01(\x03R\aperPage\"Q\n" +
	"\x16PaginateEventsResponse\x127\n" +
	"\x06events\x18\x01 \x03(\v2\x1f.freym.streams.management.EventR\x06events\"\xb6\x01\n" +
	"!PaginateEventsAfterEventIdRequest\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x14\n" +
	"\x05topic\x18\x02 \x01(\tR\x05topic\x12\x14\n" +
	"\x05types\x18\x03 \x03(\tR\x05types\x12\x19\n" +
	"\bevent_id\x18\x04 \x01(\tR\aeventId\x12\x12\n" +
	"\x04page\x18\x05 \x01(\x03R\x04page\x12\x19\n" +
	"\bper_page\x18\x06 \x01(\x03R\aperPage\"]\n" +
	"\"PaginateEventsAfterEventIdResponse\x127\n" +
	"\x06events\x18\x01 \x03(\v2\x1f.freym.streams.management.EventR\x06eventsb\x06proto3"
