...
const file_crud_management_deployment_proto_rawDesc = "" +
	...
	"\x10projection_types\x18\x03 \x03(\v2!.freym.crud.management.ObjectTypeR\x0fprojectionTypes\x12@\n" +
	"\n" +
	"crud_types\x18\x04 \x03(\v2!.freym.crud.management.ObjectTypeR\tcrudTypes\x12D\n" +
	...
	"\x06target\x18\x01 \x01(\x0e2'.freym.crud.management.DeploymentTargetR\x06target\x12\x1c\n" +
	...
	"\x06target\x18\x01 \x01(\x0e2'.freym.crud.management.DeploymentTargetR\x06target\x12\x14\n" +
	"\x05force\x18\x02 \x01(\bR\x05force\"\xa0\x01\n" +
	"\n" +
	"ObjectType\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12D\n" +
	"\n" +
	"directives\x18\x02 \x03(\v2$.freym.crud.management.TypeDirectiveR\n" +
	"directives\x128\n" +
	"\x06fields\x18\x03 \x03(\v2 .freym.crud.management.TypeFieldR\x06fields\"f\n" +
	"\rTypeDirective\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12A\n" +
	"\targuments\x18\x02 \x03(\v2#.freym.crud.management.TypeArgumentR\targuments\"y\n" +
	"\tTypeField\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x03(\tR\x04type\x12D\n" +
	"\n" +
