...
const (
	Service_DeploySchema_FullMethodName               = "/freym.crud.management.Service/DeploySchema"
	Service_ActivateSchema_FullMethodName             = "/freym.crud.management.Service/ActivateSchema"
	Service_ConfirmSchema_FullMethodName              = "/freym.crud.management.Service/ConfirmSchema"
	Service_RollbackSchema_FullMethodName             = "/freym.crud.management.Service/RollbackSchema"
	Service_RollbackSchemaByDeployment_FullMethodName = "/freym.crud.management.Service/RollbackSchemaByDeployment"
	Service_GetSchemaDeployment_FullMethodName        = "/freym.crud.management.Service/GetSchemaDeployment"
	Service_Backchannel_FullMethodName                = "/freym.crud.management.Service/Backchannel"
)
...
func (c *serviceClient) DeploySchema(ctx context.Context, in *DeploySchemaRequest, opts ...grpc.CallOption) (*DeploySchemaResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_DeploySchema_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) ActivateSchema(ctx context.Context, in *ActivateSchemaRequest, opts ...grpc.CallOption) (*ActivateSchemaResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_ActivateSchema_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) ConfirmSchema(ctx context.Context, in *ConfirmSchemaRequest, opts ...grpc.CallOption) (*ConfirmSchemaResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_ConfirmSchema_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) RollbackSchema(ctx context.Context, in *RollbackSchemaRequest, opts ...grpc.CallOption) (*RollbackSchemaResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_RollbackSchema_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) RollbackSchemaByDeployment(ctx context.Context, in *RollbackSchemaByDeploymentRequest, opts ...grpc.CallOption) (*RollbackSchemaResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RollbackSchemaResponse)
	err := c.cc.Invoke(ctx, Service_RollbackSchemaByDeployment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) GetSchemaDeployment(ctx context.Context, in *GetSchemaDeploymentRequest, opts ...grpc.CallOption) (*GetSchemaDeploymentResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_GetSchemaDeployment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "freym.crud.management.Service",
	...
	Metadata: "crud/management/service.proto",
}
